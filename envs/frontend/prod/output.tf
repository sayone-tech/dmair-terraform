...
# output "cloudfront_url_rewrite_function_arn" {
#   description = "ARN of the CloudFront URL rewrite function"
#   value       = module.cloudfront_url_rewrite.function_arn
# }
#
# output "cloudfront_url_rewrite_function_name" {
#   description = "Name of the CloudFront URL rewrite function"
#   value       = module.cloudfront_url_rewrite.function_name
# }
